...
urlpatterns = [
    ...
    path("api/v1/infection-control/", include("apps.infection_control.urls")),
    path("api/v1/quality/", include("apps.quality.urls")),
    path("api/v1/support-services/", include("apps.support_services.urls")),
    ...
    path("api/v1/mrd/", include("apps.mrd.urls")),
